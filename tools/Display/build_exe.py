"""
Build a standalone GUI executable for the Display control tool (PyInstaller).
...
Uses ``DisplayControl.spec`` in this folder. Output:
``tools/Display/dist/DisplayControl.exe`` (Windows) or
``tools/Display/dist/DisplayControl`` (Unix).
"""
...
def build_exe() -> bool:
    ...
    spec_name = "DisplayControl.spec"
    exe_name = "DisplayControl"
    ...
    print("\n" + "=" * 60)
    print("Building Display control executable...")
    print("=" * 60)
    ...
    dist_name = "DisplayControl.exe" if sys.platform == "win32" else exe_name
