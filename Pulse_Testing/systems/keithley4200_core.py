"""
Keithley 4200-SCS KXCI core (shared by PMU / SMU / custom profiles)
==================================================================
...
C programs: Equipment/SMU_AND_PMU/4200A/C_Code_with_python_scripts/.

Thin adapters (keithley4200_pmu.py, keithley4200_smu.py, keithley4200_custom.py)
subclass Keithley4200KXCICommon and only override get_system_name().
Add new tests here once; enable per profile in test_capabilities.py.
...
class Keithley4200KXCICommon(BaseMeasurementSystem, ABC):
    """Shared KXCI implementation for all Keithley 4200-SCS pulse-testing profiles."""
    ...
    def get_system_name(self) -> str:
        """Profile id, e.g. keithley4200_pmu or keithley4200_smu."""
