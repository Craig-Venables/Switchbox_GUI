...
try:
    ...
    from Helpers.Classification_Validation.gui.file_browser import FileBrowserPanel

    from Helpers.Classification_Validation.gui.review_panel import ReviewPanel

    from Helpers.Classification_Validation.gui.tuning_panel import TuningPanel

    from Helpers.Classification_Validation.gui.metrics_panel import MetricsPanel
