...
try:
    ...
    raise ImportError(
        "REQUIRED MODULE MISSING: Helpers.Analysis.core.sweep_analyzer is required for analysis.\n"
        f"Original import error: {e}\n"
        "Please ensure sweep_analyzer.py exists in the Helpers/Analysis/core/ directory.\n"
