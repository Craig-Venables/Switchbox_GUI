/* USRLIB MODULE INFORMATION
	...
	MODULE NAME: ACraig4_retention_pulse_ilimitNK
...
Module: ACraig4_retention_pulse_ilimitNK
=========================
...
int ACraig4_retention_pulse_ilimitNK( char *InstrName, long ForceCh, double ForceVRange, double ForceIRange, double iFLimit, double iMLimit, long MeasureCh, double MeasureVRange, double MeasureIRange, int max_pts, double MeasureBias, double *Volts, int volts_size, double *Times, int times_size, double *VF, int vf_size, double *IF, int if_size, double *VM, int vm_size, double *IM, int im_size, double *T, int t_size, int *npts )
{
/* USRLIB MODULE CODE */
  int stat = 1;
  int status;
  ...
  double t;
  int i, j;
  char mod[] = "ACraig4_retention_pulse_ilimitNK";
  long SeqList[1] = {1};
...
__declspec( dllexport ) int ret_getRate(double ttime, int maxpts, int *apts, int *npts) 
{
  ...
  *npts = (int) (ttime * usedrate + 0.5);
  ...
  return usedrate;
/* USRLIB MODULE END  */
} 		/* End ACraig4_retention_pulse_ilimitNK.c */
