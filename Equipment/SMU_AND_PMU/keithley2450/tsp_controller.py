...
if __name__ == "__main__":
    ...
    try:
        ...
        # Run varying width pulses test
        print("-" * 70)
        print("Varying Width Pulses Test")
        print("-" * 70)
        print("Running varying width pulse test with measurements...")
        print("  Pulse widths: [50µs, 100µs, 500µs, 1ms]")
        print("  Pulses per width: 5")
        print("  Pulse voltage: 1.0V")
        print("  Read voltage: 0.2V")
        print()
