/* USRLIB MODULE INFORMATION
	...
	MODULE NAME: ACraig1_PMU_retention
	...
	ARGUMENTS:
		...
		NumbMeasPulses,	int,	Input,	8,	8,	100
...
/* USRLIB MODULE CODE */
  ...
  probeCapacity = NumbMeasPulses + 1; // one baseline plus one entry per requested pulse
...
// are returned via of the voltage(VF and VM) and current (IF and IM) output arrays for both channels.
      ...
      stat = ACraig1_retention_pulse_ilimitNK
    ( inst, 
