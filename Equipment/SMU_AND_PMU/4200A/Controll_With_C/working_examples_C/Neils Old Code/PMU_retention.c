...
/* USRLIB MODULE CODE */
  ...
  char inst[] = "PMU1";
  int i, stat;
  double times[52]; // was 20 needs to be increased by the number of new pulses *4
  double volts[53];    // was 21 needs to be increased by the number of new pulses *4

//  18th Jan 2025 create an array of measMinTime and measMaxTime so that we know where find I and V in waveform
double measMinTime[12];
double measMaxTime[12];
...
// this needs changing 
int NumberRepeatedMeasurements=8;
...
for (ProbeResNumb=0; ProbeResNumb<11;ProbeResNumb++)  
    {
