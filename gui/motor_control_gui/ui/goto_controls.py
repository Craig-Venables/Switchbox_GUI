...
def create_goto_controls(gui: Any, parent: tk.Frame, start_expanded: bool = True) -> None:
    """Build go-to-position controls."""
    c = config.COLORS
    collapsible = CollapsibleFrame(
        parent, "📍 Go To Position", bg_color=c["bg_dark"], fg_color=c["fg_primary"], start_expanded=start_expanded
    )
