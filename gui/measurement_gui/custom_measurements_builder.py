...
_PROJECT_ROOT = Path(__file__).resolve().parents[2]  # gui/measurement_gui/custom_measurements_builder.py -> gui -> root
...
class CustomMeasurementsBuilder:
    ...
    def __init__(self, parent: tk.Misc, gui_instance: object, json_path: Optional[str] = None):
        """
        ...
        # Use provided path or default to project root Json_Files
