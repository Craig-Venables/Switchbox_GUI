...
class TSPTestingGUI(tk.Toplevel):
    ...
    def load_default_terminals(self) -> str:
        ...
        config_file = _PROJECT_ROOT / "Json_Files" / "tsp_gui_config.json"
        try:
            if config_file.exists():
                with open(config_file, 'r') as f:
                    config = json.load(f)
    ...
    def _load_simple_save_config(self):
        ...
        config_file = _PROJECT_ROOT / "Json_Files" / "tsp_gui_save_config.json"
        try:
            if config_file.exists():
                with open(config_file, 'r') as f:
                    config = json.load(f)
    ...
    def load_presets_from_file(self):
        ...
        preset_file = _PROJECT_ROOT / "Json_Files" / "tsp_test_presets.json"
