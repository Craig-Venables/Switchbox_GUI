...
from .connection import build_connection_section, toggle_connection_section, update_terminals_visibility
from .connection_compact import build_connection_bar
